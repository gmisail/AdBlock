...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/images/ad1.jpg");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/ad2.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/ad3.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/ad4.jpg");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/Desktop.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/PopUp.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/Spot.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/Track.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/music/Panic.wav");
		types.push (lime.Assets.AssetType.SOUND);
		
		
		urls.push ("assets/sounds/Destroy.wav");
		types.push (lime.Assets.AssetType.SOUND);
